package com.enesdokuz.goodsounds.ui.favorite.adapter
...
class FavoriteAdapter(private val list: ArrayList<Sound>, val listener: SoundListener) :
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.view.imgFavSoundItem.setOnClickListener {
            listener.onClickedFav(list[position].id, false)
